...
const hrmsArticleImage = "https://images.pexels.com/photos/7109314/pexels-photo-7109314.jpeg?auto=compress&cs=tinysrgb&w=800";
...
const categoryToneClasses = {
  green: "bg-[#e6f5ee] text-[#0d8048]",
  pink: "bg-[#fff0f5] text-[#bd245a]",
  purple: "bg-[#f4eaff] text-[#5d1498]",
  yellow: "bg-[#fff7dc] text-[#9a6b00]",
};
    ...
    faqs: [
      {
        ...
        answer:
          "Every workplace covered by the Act must follow its prevention, committee, complaint-handling and confidentiality requirements. Organizations with 10 or more employees must constitute an Internal Committee.",
      },
      {
        question: "Who can file a POSH complaint?",
        answer:
          "An aggrieved woman can submit a written complaint to the Internal Committee or Local Committee. The law also allows assistance when she cannot make the complaint in writing and recognizes limited situations where another specified person may submit it.",
      },
      {
        question: "Does POSH apply to remote work?",
        answer:
          "Yes. The workplace definition is broad and can cover remote work, client visits, offsites, business travel, employer-arranged transport and work-related digital communication.",
      },
    ],
  },
  {
    slug: "top-hrms-software-india-2026",
    category: "HR technology",
    categoryTone: "purple",
    title: "Top 10 HRMS Software in India (2026): The Most Reliable Platforms",
    description: "Compare payroll, attendance, compliance, performance, integrations, pricing models and scalability before choosing an HRMS for your business.",
    date: "04 January 2026",
    readTime: "10 min read",
    image: hrmsArticleImage,
    author: "360 BizHealth Editorial Team",
    quickAnswer: [
      "A good HRMS brings employee records, payroll, attendance, leave, recruitment, performance and analytics into one dashboard.",
      "For India, PF, ESIC, TDS and Professional Tax support should be part of the evaluation.",
      "Shortlist two or three vendors, run a personalized demo and compare total cost of ownership—not only the headline price.",
      "Quikchex, Keka, Zoho People, GreytHR, Zimyo, factoHR, HROne, Darwinbox, ZingHR and Pocket HRMS are covered in this comparison.",
    ],
    sections: [
      {
        heading: "What is HRMS software?",
        paragraphs: [
          "An HRMS (Human Resource Management System) automates and manages employee records, recruitment, attendance, leave, payroll, statutory compliance, performance reviews and analytics from a single dashboard. It reduces manual errors, speeds up HR cycles and improves the employee experience.",
        ],
      },
      {
        heading: "Why HRMS matters in 2026",
        bullets: [
          "India-specific payroll and labour-law compliance",
          "Remote and hybrid workforce management with mobile or geo-tagged attendance",
          "Scalable payroll automation as tax rules evolve",
          "Employee self-service portals that reduce routine HR workload",
          "Data-driven decisions through workforce analytics and dashboards",
        ],
      },
      {
        heading: "Features and modules to evaluate",
        bullets: [
          "Payroll automation for salary, deductions, bonuses, payslips and multi-component structures",
          "Attendance and leave management with biometric, mobile, location or selfie attendance",
          "Recruitment and onboarding with ATS, interview scheduling, documents and joining workflows",
          "Performance and engagement tools for KPIs, OKRs, appraisals, feedback, surveys and recognition",
          "Employee self-service for payslips, tax declarations, leave, attendance and profile updates",
          "Analytics, custom reports, attrition trends and exportable management dashboards",
        ],
      },
      {
        heading: "Indian statutory compliance checklist",
        bullets: [
          "Provident Fund (PF): employee and employer contributions, calculations and filings",
          "Employee State Insurance (ESI): deductions and eligibility management",
          "Tax Deducted at Source (TDS): tax calculations, Form 16 and required reports",
          "Professional Tax (PT): state-specific deductions",
          "Ask the vendor how quickly it updates the system when regulations change.",
        ],
      },
      {
        heading: "Market comparison guide",
        table: {
          headers: ["Platform", "Best for", "Standout feature"],
          rows: [
            ["Quikchex", "SMEs to large enterprises", "Integrated payroll, compliance and HRMS"],
            ["Keka", "Mid-size and growing teams", "Payroll and engagement tools"],
            ["Zoho People", "Startups and SMEs", "Integrations and flexible workflows"],
            ["GreytHR", "Compliance-centric teams", "Statutory compliance tools"],
            ["Zimyo", "SMEs focused on automation", "AI-backed HR automation"],
            ["factoHR", "SMEs and field teams", "Attendance and payroll focus"],
            ["HROne", "Mid-sized companies", "User-centric HR workflows"],
            ["Darwinbox", "Large enterprises", "Automation and analytics"],
            ["ZingHR", "Multi-location operations", "Comprehensive HR features"],
            ["Pocket HRMS", "SMEs", "Simple and scalable HRMS"],
          ],
        },
      },
      {
        heading: "1. Quikchex — integrated payroll and HRMS",
        paragraphs: [
          "Quikchex centralizes HR, payroll, attendance, leave, recruitment, performance, compliance and analytics for Indian businesses. Its strengths include EPF, ESIC and TDS automation, mobile attendance and quick onboarding. Modular pricing may require a tailored discussion, and highly customized requests can need setup assistance.",
        ],
      },
      {
        heading: "2. Keka — for growing teams",
        paragraphs: [
          "Keka combines payroll, HR, performance management and applicant tracking in a modern dashboard. It is known for workflow automation, strong payroll processing and a good mobile experience. Pricing can be high for smaller teams and feature depth may require training.",
        ],
      },
      {
        heading: "3. Zoho People — part of a wider ecosystem",
        paragraphs: [
          "Zoho People is useful for businesses already using Zoho apps, with employee records, onboarding, workflows, leave and attendance. Payroll generally needs the Zoho Payroll add-on. Complex configuration and premium support may add cost.",
        ],
      },
      {
        heading: "4. GreytHR — compliance-centric HRMS",
        paragraphs: [
          "GreytHR is trusted for payroll and statutory compliance, attendance and leave tracking. It suits small and medium teams that prioritize accurate reporting, though its interface can feel dated and advanced HR features are limited.",
        ],
      },
      {
        heading: "5–10. More platforms to consider",
        bullets: [
          "Zimyo: AI-powered workflows, ESS, configurable dashboards and mobile access; advanced setup may be required.",
          "factoHR: simple core HR, payroll, attendance and compliance for SMEs and field teams; analytics are less powerful.",
          "HROne: intuitive HR, payroll, recruitment and performance workflows; final pricing is custom and learning can take time.",
          "Darwinbox: enterprise-grade automation, analytics and mobile experience; implementation and cost are higher.",
          "ZingHR: broad performance, workforce and compliance modules for multi-location organizations; setup can be complex.",
          "Pocket HRMS: affordable core HR, payroll, attendance, ESS and AI chatbot features; less suited to large enterprises.",
        ],
      },
      {
        heading: "Pricing, value and scalability",
        paragraphs: [
          "Common models include per-employee pricing, flat fees and hybrid pricing. Compare implementation, training, support, integrations and add-on costs before deciding. A platform that works for today’s headcount should also support tomorrow’s entities, locations and compliance needs. Create a shortlist of two or three platforms and involve finance and business leadership in the demo.",
        ],
      },
      {
        heading: "Exhaustive HRMS evaluation checklist",
        bullets: [
          "Core HR: centralized database, custom fields, org charts, role-based access and multi-entity support",
          "Payroll: automated processing, PF, ESIC, PT, TDS, Form 16, Form 24, ECR and variable pay",
          "Attendance: biometrics, geo-tagging, shifts, rosters, overtime and leave calculations",
          "Recruitment: ATS, offer letters, onboarding workflows and background verification",
          "Performance: goals, OKRs, appraisals, 360-degree feedback and learning integrations",
          "ESS: payslips, tax declarations, mobile access, leave, attendance and reimbursements",
          "Analytics: dashboards, custom reports, attrition and workforce insights",
          "Integrations: accounting, attendance, open APIs and SSO",
          "Security: encryption, permissions, audit logs and access tracking",
          "Implementation: migration, training, support, transparent pricing and scalable plans",
        ],
      },
    ],
    faqs: [
      {
        question: "What features should a good HRMS include?",
        answer:
          "Core HR, payroll, attendance and leave, recruitment, performance, employee self-service, statutory compliance, analytics, integrations and strong access controls are the usual essentials.",
      },
      {
        question: "How much does HRMS software cost in India?",
        answer:
          "The guide’s market range is approximately ₹20 to ₹150 per employee per month, depending on modules, headcount, support and implementation. Vendors may also charge setup or add-on fees.",
      },
      {
        question: "Can HRMS software improve employee experience?",
        answer:
          "Yes. Self-service access, quicker approvals, digital payslips, transparent leave balances and better HR communication reduce friction for employees.",
      },
    ],
  },
  {
    ...
    faqs: [
      {
        question: "How many types of leave should a company offer?",
        answer:
          "Many businesses offer five to eight core categories such as public holidays, earned, sick, casual and parental leave. The exact list should reflect legal requirements, work model and employee needs.",
      },
      {
        question: "Can unused leave be carried forward?",
        answer:
          "Often yes, but the limit depends on company policy, employee category, location and applicable law. The policy should state the cap clearly.",
      },
      {
        question: "Should startups have a formal leave policy?",
        answer:
          "Yes. A written policy prevents inconsistent approvals, clarifies expectations and becomes increasingly important as more managers and employees join the team.",
      },
    ],
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "Example 1: Basic ₹30,000 + DA ₹5,000 with 10 unused days gives ₹35,000 ÷ 30 = ₹1,166.67 per day and ₹11,666.70 encashment. Example 2: Basic ₹40,000 + DA ₹10,000 with 15 days gives ₹25,000.05. Example 3: Basic ₹50,000 + DA ₹10,000 with 20 days gives ₹40,000.",
        ],
      },
      {
    ...
    faqs: [
      {
        question: "How long does FnF take in India?",
        answer:
          "Business timelines vary, but the guide recommends a typical internal target of 30–45 days after the last working day, depending on approvals, clearances and outstanding claims.",
      },
      {
        question: "Is gratuity part of FnF?",
        answer:
          "It can be included when the employee meets eligibility requirements. Some organizations settle it separately, but the FnF communication should clearly show whether it applies.",
      },
      {
        question: "Can FnF be delayed?",
        answer:
          "Incomplete handover, asset returns, approvals, reimbursements or disputes can cause delays. A structured workflow and clear employee communication help minimize them.",
      },
      {
        question: "Can PF be included in FnF?",
        answer:
          "PF is usually processed separately through the EPF system, where the employee can transfer or withdraw the balance subject to applicable rules. It should still be explained in the final communication.",
      },
    ],
  },
];
...
function SearchBox() {
  ...
  return (
    <div className="relative max-w-[650px]">
      <div
        className={`flex items-center rounded-[14px] border-2 bg-white px-5 shadow-[0_3px_10px_rgba(0,0,0,0.05)] ${
          query
            ? "border-[#fc326c] shadow-[0_3px_10px_rgba(255,105,180,0.18)]"
            : "border-[#e0e0e0]"
        }`}
      >
        <Search className="h-5 w-5 shrink-0 text-[#7b18cc]" />
        <input
          value={query}
          onChange={(event) => setQuery(event.target.value)}
          placeholder="Search HR, payroll or compliance guides"
          className="w-full border-0 bg-transparent px-3 py-4 text-sm font-medium text-[#272127] outline-none placeholder:text-slate-400"
        />
      </div>
      {query && (
        <div className="absolute left-0 right-0 top-full z-20 mt-2 overflow-hidden rounded-[14px] border border-slate-200 bg-white p-2 shadow-[0_10px_30px_rgba(0,0,0,0.12)]">
          {results.length ? (
            results.map((article) => (
              <Link
                key={article.slug}
                ...
                onClick={() => setQuery("")}
                className="flex items-center justify-between gap-4 rounded-lg px-3 py-3 text-sm hover:bg-[#f9f2ff]"
              >
                <span>{article.title}</span>
                <ArrowUpRight className="h-4 w-4 shrink-0 text-[#7b18cc]" />
              </Link>
            ))
          ) : (
  ...
  return (
    <div
      className={`flex flex-wrap items-center gap-x-5 gap-y-2 text-xs ${
        light ? "text-white/75" : "text-[#696969]"
      }`}
    >
...
function ArticleCard({ article, compact = false }) {
  return (
    <article
      className={`group overflow-hidden rounded-lg border border-[#f3f5f8] bg-white shadow-[0_3px_8px_rgba(0,0,0,0.1)] transition duration-300 hover:-translate-y-1 hover:shadow-[0_10px_24px_rgba(25,55,101,0.12)] ${
        compact ? "flex min-h-[170px]" : "flex flex-col"
      }`}
    >
      <Link
        to={`/blog/${article.slug}`}
        className={`${compact ? "w-2/5 shrink-0" : "aspect-[16/10]"} overflow-hidden`}
      >
        <img
          src={article.image}
          alt=""
      ...
      <div className={`${compact ? "p-4" : "flex flex-1 flex-col p-5"}`}>
        <span
          className={`inline-flex w-fit rounded-full px-3 py-1 text-[11px] font-medium ${
            categoryToneClasses[article.categoryTone]
          }`}
        >
          {article.category}
        </span>
        <Link
          to={`/blog/${article.slug}`}
          className={`mt-3 block font-bold leading-tight text-[#272127] hover:text-[#7b18cc] ${
        ...
        {!compact && (
          <p className="mt-2 line-clamp-3 text-sm leading-6 text-[#4f5354]">
            {article.description}
          </p>
        )}
        <div
          className={`${compact ? "mt-4" : "mt-auto pt-6"} flex items-center justify-between gap-3`}
        >
          <Link
            to={`/blog/${article.slug}`}
            className="inline-flex items-center gap-1 text-sm font-medium text-[#7b18cc]"
          >
            Read more <ArrowRight className="h-3.5 w-3.5" />
          </Link>
          <span className="text-[10px] text-[#696969]">{article.date}</span>
        </div>
      </div>
    </article>
  );
...
export function BlogArticle({ slug }) {
  ...
  return (
    <div className="numeric-figures min-h-screen bg-white text-[#272127]">
      <main className="pt-8 lg:pt-12">
        <section className="bg-white py-8 text-[#272127] sm:py-10">
          <div className="mx-auto max-w-[1312px] px-5 sm:px-6">
            <div className="mb-4">
              <Link to="/blog" className="inline-flex items-center gap-2 text-sm font-semibold text-[#7b18cc] hover:underline">
            ...
            <h1 className="mt-5 max-w-4xl font-serif text-4xl font-normal leading-tight sm:text-5xl">
              {article.title}
            </h1>
            <p className="mt-5 max-w-3xl text-base leading-7 text-[#4f5354] sm:text-lg">
              {article.description}
            </p>
            <div className="mt-5 flex flex-wrap items-center gap-4">
              ...
              <span className="inline-flex items-center gap-2 text-sm text-[#696969]">
              ...
              <a
                ...
                className="grid h-8 w-8 place-items-center rounded-full border border-slate-200 hover:bg-slate-50"
              >
        ...
        <div className="mx-auto grid max-w-[1440px] gap-4 px-5 py-6 sm:px-6 lg:grid-cols-[220px_minmax(0,1fr)_260px] lg:items-start">
          <aside className="lg:sticky lg:top-28">
            <button
              onClick={() => setMobileToc((value) => !value)}
              className="flex w-full items-center justify-between rounded-2xl bg-[#f9f2ff] px-5 py-4 text-left font-semibold text-[#334d74] lg:cursor-default"
            >
              <span>Table of contents</span>
              <ChevronDown
                className={`h-5 w-5 transition lg:hidden ${
                  mobileToc ? "rotate-180" : ""
                }`}
              />
            </button>
            <nav
              className={`${
                mobileToc ? "block" : "hidden"
              } rounded-b-2xl bg-[#f9f2ff] p-4 lg:block lg:rounded-2xl lg:pt-2`}
            >
                ...
                {tocItems.map((section) => (
                  <li key={section.id}>
                    <a
                      ...
                      className="flex items-start gap-2 rounded-lg px-2 py-2 text-sm leading-5 text-[#334d74] hover:bg-white hover:text-[#7b18cc]"
                    >
          ...
          <article className="min-w-0">
            <div className="mb-5 rounded-2xl bg-[#f9f2ff] p-6 sm:p-7">
              <h2 className="text-2xl font-semibold leading-tight text-[#5d1498]">
                In short
              </h2>
              <ul className="mt-5 grid gap-3">
                {article.quickAnswer.map((answer) => (
                  <li
                    key={answer}
                    className="flex gap-3 text-base leading-7 text-[#272127]"
                  >
                    <Check className="mt-1 h-5 w-5 shrink-0 text-[#7b18cc]" />
                    {answer}
                  </li>
                ))}
              </ul>
            ...
            <div className="space-y-7">
              {article.sections.map((section, index) => (
                ...
                >
                  <h2 className="text-2xl font-bold leading-tight tracking-[-0.025em] text-[#272127] sm:text-3xl">
                    {section.heading}
                  </h2>
                  {section.paragraphs?.map((paragraph) => (
                    <p
                      key={paragraph}
                      className="mt-5 text-base leading-8 text-[#272127] sm:text-lg"
                    >
                      {paragraph}
                    </p>
                  ))}
                  {section.bullets && (
                    <ul className="mt-5 grid gap-3 pl-5 text-base leading-7 text-[#272127] sm:text-lg">
                      {section.bullets.map((bullet) => (
                        <li
                          key={bullet}
                          className="list-disc pl-2 marker:text-[#7b18cc]"
                        >
                          {bullet}
                        </li>
                      ))}
                  ...
                  {section.numbered && (
                    <ol className="mt-5 grid gap-4 pl-6 text-base leading-7 text-[#272127] sm:text-lg">
                      {section.numbered.map((item) => (
                        <li
                          key={item}
                          className="list-decimal pl-2 marker:font-bold marker:text-[#7b18cc]"
                        >
                          {item}
                        </li>
                      ))}
                  ...
                  {section.table && (
                    <div className="mt-6 overflow-x-auto rounded-xl border border-[#d5d9e0]">
                      <table className="min-w-[650px] w-full border-collapse text-left text-sm">
                        <thead className="bg-[#f9f2ff] text-[#46077a]">
                          <tr>
                            {section.table.headers.map((header) => (
                              <th
                                key={header}
                                className="border-b border-[#d5d9e0] px-4 py-3 font-bold"
                              >
                                {header}
                              </th>
                            ))}
            ...
            <section className="mt-14 rounded-2xl bg-[#f9f2ff] p-6 sm:p-8">
              <h2 className="text-2xl font-bold text-[#272127]">
                About the author
              </h2>
              <div className="mt-5 flex items-start gap-4">
                <span className="grid h-12 w-12 shrink-0 place-items-center rounded-full bg-[#38095e] text-xs font-bold text-white">
                  360
                </span>
                <div>
                  <h3 className="font-bold">{article.author}</h3>
                  <p className="mt-1 text-sm leading-6 text-slate-600">
                    Our editorial team turns complex HR, payroll and compliance
                    topics into practical guidance for business leaders.
                  </p>
                </div>
              </div>
            </section>
          ...
          <aside className="space-y-6 lg:sticky lg:top-28">
            <div className="overflow-hidden rounded-2xl bg-[#f9f2ff] p-5">
              <Sparkles className="h-7 w-7 text-[#7b18cc]" />
              <h2 className="mt-4 text-xl font-bold leading-tight">
                Make benefits and HR simpler.
              </h2>
              <p className="mt-3 text-sm leading-6 text-[#4f5354]">
                Talk to our team about a smoother, more compliant employee
                experience.
              </p>
              <Link
                to="/contact"
                className="mt-5 inline-flex rounded-full bg-[#e6377a] px-5 py-2.5 text-sm font-semibold text-white hover:bg-[#bd245a]"
              >
                Get a quote
              </Link>
            </div>
        ...
        <section className="mx-auto max-w-[1440px] px-5 pb-12 sm:px-6">
          <div className="grid gap-6 rounded-2xl bg-gradient-to-br from-[#7b18cc] to-[#38095e] p-7 text-white sm:p-10 lg:grid-cols-[1fr_auto] lg:items-center">
            <div>
              <p className="text-sm font-semibold uppercase tracking-[0.14em] text-[#ffdc79]">
                Better HR starts here
              </p>
              <h2 className="mt-3 max-w-2xl font-serif text-3xl font-normal sm:text-4xl">
                Give your team the clarity and support they need.
              </h2>
              <p className="mt-3 max-w-2xl text-white/80">
                Bring payroll, compliance and employee operations together with an
                experienced partner.
              </p>
            </div>
            <Link
              to="/contact"
              className="inline-flex w-fit items-center gap-2 rounded-full bg-[#e6377a] px-6 py-3 font-semibold text-white hover:bg-[#bd245a]"
            >
        ...
        <section className="bg-[#38095e] px-5 py-14 text-white sm:px-6">
          <div className="mx-auto max-w-[900px]">
            ...
            <div className="mt-6">
              {article.faqs.map((faq, index) => (
                <div key={faq.question} className="border-b border-white/40">
                  <button
                    onClick={() =>
                      setOpenFaq(openFaq === index ? null : index)
                    }
                    className="flex w-full items-center justify-between gap-6 py-5 text-left text-base font-semibold sm:text-lg"
                  >
                  ...
                  {openFaq === index && (
                    <p className="pb-5 text-base leading-7 text-white/75">
                      {faq.answer}
                    </p>
                  )}
                </div>
...
export default function Blog() {
  ...
  return (
    <div className="min-h-screen bg-white text-[#272127]">
      <main className="pt-8 lg:pt-12">
        <section className="mx-auto max-w-[1312px] px-5 pb-6 pt-5 sm:px-6 sm:pt-6">
          <SearchBox />
        </section>

        <section className="mx-auto max-w-[1312px] px-5 pb-16 sm:px-6">
          <Link
            to={`/blog/${featured.slug}`}
            className="group grid overflow-hidden rounded-2xl bg-white shadow-[0_0_15px_rgba(0,0,0,0.1)] lg:grid-cols-2"
          >
            <div className="min-h-[260px] overflow-hidden lg:min-h-[340px]">
              <img
                src={featured.image}
                alt=""
                className="h-full w-full object-cover transition duration-500 group-hover:scale-105"
            ...
            <div className="flex flex-col justify-center p-7 sm:p-10">
              <span
                className={`inline-flex w-fit rounded-full px-3 py-1.5 text-xs font-medium ${
                  categoryToneClasses[featured.categoryTone]
                }`}
              >
                {featured.category}
              </span>
              <h1 className="mt-5 text-3xl font-bold leading-tight text-[#272127] sm:text-4xl">
                {featured.title}
              </h1>
              <p className="mt-4 text-base leading-7 text-[#4f5354]">
                {featured.description}
              </p>
              <div className="mt-6 flex items-center gap-3">
                <span className="grid h-10 w-10 place-items-center rounded-full bg-[#38095e] text-white">
        ...
        <section
          id="latest"
          className="mx-auto max-w-[1312px] scroll-mt-24 px-5 pb-16 sm:px-6"
        >
          <h2 className="font-serif text-3xl font-normal text-[#272127] sm:text-4xl">
            {selectedTopic ? `${selectedTopic} Articles` : "Our Recent Articles"}
          </h2>
          <p className="mt-2 text-base text-[#4f5354]">
          ...
          <button
            type="button"
            onClick={() => selectTopic("Business guides")}
            className="mx-auto mt-12 flex items-center gap-2 rounded-full border-2 border-[#fc326c] px-6 py-2.5 text-sm font-medium text-[#fc326c] hover:bg-[#fc326c] hover:text-white"
          >
        ...
        <section
          id="topics"
          className="border-y border-slate-100 bg-[#f9f2ff] py-14"
        >
          <div className="mx-auto max-w-[1312px] px-5 sm:px-6">
            <h2 className="font-serif text-3xl font-normal text-[#272127] sm:text-4xl">
              Explore by topic
            ...
            <div className="mt-7 flex flex-wrap gap-3">
              <button
                type="button"
                onClick={() => selectTopic("HR compliance")}
                className={`rounded px-3 py-1.5 text-sm font-medium transition ${
                  selectedTopic === "HR compliance"
                    ? "bg-[#46077a] text-white"
                    : "bg-white text-[#5d1498] hover:bg-[#46077a] hover:text-white"
                }`}
              >
                HR compliance
              </button>
              <button
                type="button"
                onClick={() => selectTopic("HR technology")}
                className={`rounded px-3 py-1.5 text-sm font-medium transition ${
                  selectedTopic === "HR technology"
                    ? "bg-[#46077a] text-white"
                    : "bg-white text-[#5d1498] hover:bg-[#46077a] hover:text-white"
                }`}
              >
              ...
              <button
                type="button"
                onClick={() => selectTopic("Payroll & exits")}
                className={`rounded px-3 py-1.5 text-sm font-medium transition ${
                  selectedTopic === "Payroll & exits"
                    ? "bg-[#46077a] text-white"
                    : "bg-white text-[#5d1498] hover:bg-[#46077a] hover:text-white"
                }`}
              >
              ...
              <button
                type="button"
                onClick={() => selectTopic("Workplace culture")}
                className={`rounded px-3 py-1.5 text-sm font-medium transition ${
                  selectedTopic === "Workplace culture"
                    ? "bg-[#46077a] text-white"
                    : "bg-white text-[#5d1498] hover:bg-[#46077a] hover:text-white"
                }`}
              >
            ...
            {selectedTopic && (
              <button
                ...
                className="mt-5 text-sm font-semibold text-[#7b18cc] hover:text-[#46077a]"
              >
                Show all articles <span aria-hidden="true">→</span>
              </button>
            )}
          </div>
        </section>
        ...
        <section
          id="guides"
          className="mx-auto max-w-[1312px] scroll-mt-24 px-5 py-16 sm:px-6"
        >
          <div className="flex flex-col justify-between gap-3 sm:flex-row sm:items-end">
            ...
            <span className="text-sm font-medium text-[#7b18cc]">
        ...
        <section className="mx-5 mb-16 grid max-w-[1312px] gap-8 rounded-2xl border border-[#d5d9e0] p-6 shadow-[0_2px_5px_rgba(0,0,0,0.2)] sm:mx-auto sm:p-8 lg:grid-cols-2 lg:items-center">
          <img
            src={teamRetreats}
          ...
          />
          <div>
            <p className="text-sm font-semibold uppercase tracking-[0.14em] text-[#7b18cc]">
              Build a stronger people function
            </p>
            <h2 className="mt-3 max-w-md text-3xl font-medium leading-tight text-[#272127]">
              Make employee operations simpler for everyone.
            </h2>
            <p className="mt-4 max-w-lg text-base leading-6 text-[#4f5354]">
              From payroll and compliance to employee benefits, get one partner
              for the systems and support your team needs.
            </p>
            <Link
              to="/contact"
              className="mt-7 inline-flex items-center gap-2 rounded-full bg-[#e6377a] px-7 py-3 text-sm font-semibold text-white hover:bg-[#bd245a]"
            >
