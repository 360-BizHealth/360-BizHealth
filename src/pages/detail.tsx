...
const quikchexFeatureData = [
  {
    ...
    description: "Simplify the employee onboarding process with automated workflows, helping new hires integrate smoothly into the team",
    image: "https://images.pexels.com/photos/36765734/pexels-photo-36765734.jpeg?auto=compress&cs=tinysrgb&w=800",
  ...
  },
  {
    ...
    image: "https://images.pexels.com/photos/5483148/pexels-photo-5483148.jpeg?auto=compress&cs=tinysrgb&w=800",
  ...
  },
  {
    ...
    image: "https://images.pexels.com/photos/8872195/pexels-photo-8872195.jpeg?auto=compress&cs=tinysrgb&w=800",
  ...
  },
  {
    ...
    image: "https://images.pexels.com/photos/4968573/pexels-photo-4968573.jpeg?auto=compress&cs=tinysrgb&w=800",
        ...
        <section className="bg-[#5D3A6A] pb-24 pt-40 text-white">
          <div className="relative z-10 mx-auto flex max-w-[1180px] flex-col items-center gap-12 px-6 text-left lg:flex-row">
            <div className="flex-1 space-y-6">
              ...
              <button onClick={() => setModalOpen(true)} className="inline-flex items-center gap-3 rounded-full bg-[#FF5C35] px-8 py-4 text-sm font-bold text-white shadow-lg shadow-[#FF5C35]/20 transition hover:bg-[#FF5C35]/95 cursor-pointer"><span>Book A Free Consultation</span><span className="flex h-5 w-5 items-center justify-center rounded-full bg-white/20"><ArrowRight className="h-3 w-3 text-white" /></span></button>
            </div>
          ...
          <div className="quikchex-content-width">
            {features.map((feature) => (
              <div key={feature.title} className={`quikchex-feature-row ${feature.imageFirst ? "" : "flex-row-reverse"}`}>
                <div className="quikchex-feature-visual"><img src={feature.image} alt={feature.imageAlt} loading="eager" decoding="sync" /></div>
        ...
        <section className="bg-white pb-24">
          <div className="mx-auto max-w-[1180px] px-6">
            <div className="relative flex flex-col items-center gap-6 overflow-hidden rounded-[2.5rem] border border-[#E8DDD3] bg-[#FEF4EA] p-10 text-center text-slate-800 shadow-sm md:p-14">
              ...
              <button onClick={() => setModalOpen(true)} className="relative flex items-center gap-2 rounded-full bg-[#FF5C35] px-8 py-4 text-sm font-bold text-white shadow-md shadow-[#FF5C35]/15 transition hover:bg-[#FF5C35]/95 cursor-pointer"><span>Book a Demo</span><ArrowRight className="h-4 w-4" /></button>
            </div>
          </div>
        </section>
      </main>
