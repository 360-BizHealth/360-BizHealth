...
export const ROUTES = [
  ...
  { path: "/blog/:slug", element: <Blog />, title: "Blog Article | 360 Biz Health",
    desc: "In-depth guide and practical notes for people operations and business growth.", crumbs: [["Blog", "/blog"]] },
  { path: "/resources/blogs-news/:slug", element: <Blog />, title: "Blog Article | 360 Biz Health",
    desc: "In-depth guide and practical notes for people operations and business growth.", crumbs: [["Blog", "/blog"]] },
